 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1600990510, nBits=1e0ffff0, nNonce=1000520, vtx=1)
...
{
    const char* pszTimestamp = "2017. Crypto.ba";
    const CScript genesisOutputScript = CScript() << ParseHex("040fd68c845c15dc0329c49a8999c5e99ee5ffceb07821cde5f6eb6e903e1d18b23ba58ac9b56bfbeb845bd4129d40a4c2f6c8885b79bf270f333b5d66e5db1cc5") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000c63f5826a523923939a5adf28657c2a6b76764f1af99bb39437006489d3"); 
        ...
        vAlertPubKey = ParseHex("04e807f1caf222eb75de194e8b83c065c89fbce06b60d0968cdc832bd1ce17ef264362b43df7fd97cc7a1a38d69d6b7aab3c16cf7a3a9988fa8816c69a6a3016e1");
        nDefaultPort = 23506;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1600990510, 1000520, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c63f5826a523923939a5adf28657c2a6b76764f1af99bb39437006489d3"));
        ...
        // RuxCrypto BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // RuxCrypto BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // RuxCrypto BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000c63f5826a523923939a5adf28657c2a6b76764f1af99bb39437006489d3"))
        };

        chainTxData = ChainTxData{
            1600990510, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000341adf1dd4375bef8ff8059b4268fe0282d8a66f8cf5419bd6b13fbb77b"); 

        pchMessageStart[0] = 0x3a;
        pchMessageStart[1] = 0x40;
        pchMessageStart[2] = 0x12;
        pchMessageStart[3] = 0x46;
        vAlertPubKey = ParseHex("04f4b54198f71c995cb743636c6706b834b7806efca31d8e730e1160be434b84f341dfb7cd8970246bb77a9f5de094f16678bb5cac9c994616023a63421e9df518");
        nDefaultPort = 33506;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1600990515UL, 176368UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000341adf1dd4375bef8ff8059b4268fe0282d8a66f8cf5419bd6b13fbb77b"));
        assert(genesis.hashMerkleRoot == uint256S("0x38f611bbc7d2e792fddd4804f2c570a6b1e86e9314b570fdc5d881e20cc76fa7"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,188);
        // Testnet RuxCrypto BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet RuxCrypto BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet RuxCrypto BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"RYRLJtt7w93Hk2HeKM2dJ9Ub1pYQwJtPJR"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000341adf1dd4375bef8ff8059b4268fe0282d8a66f8cf5419bd6b13fbb77b"))
        };

        chainTxData = ChainTxData{
            1600990515, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1600990520, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0550380d660e6170a1081bc3dc765fb192e689d7310c818dab22c8783408102b"));
        assert(genesis.hashMerkleRoot == uint256S("0x38f611bbc7d2e792fddd4804f2c570a6b1e86e9314b570fdc5d881e20cc76fa7"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("ruxcryptoevo.org",  "devnet-seed.ruxcryptoevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x0550380d660e6170a1081bc3dc765fb192e689d7310c818dab22c8783408102b"))
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,188);
        // Regtest RuxCrypto BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest RuxCrypto BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest RuxCrypto BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
